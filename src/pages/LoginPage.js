        ...
        <div className="flex justify-center items-center min-h-screen p-4">
            <div className="glass-panel p-8 sm:p-12 w-full max-w-md text-center transform transition-all hover:scale-[1.01] duration-500">
                ...
                <div className="mb-8">
                    <img 
                        src="/logo192.png" 
                        alt="OFG Connects Logo" 
                        // Changed w-20 -> w-32 (128px) and rounded-2xl -> rounded-3xl
                        className="w-32 h-32 mx-auto mb-6 rounded-3xl shadow-2xl shadow-blue-500/20 hover:scale-105 transition-transform duration-300" 
                    />
                    ...
                    <p className="mt-2 text-gray-600 dark:text-gray-400">
                        Sign in to continue to OFG Connects
                    </p>
                </div>
