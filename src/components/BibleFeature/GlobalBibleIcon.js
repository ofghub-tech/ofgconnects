...
export default function GlobalBibleIcon() {
    ...
    return (
        <button
            ...
            className="fixed z-30 flex items-center justify-center w-16 h-16 p-4 text-white bg-blue-600 rounded-full shadow-lg bottom-5 right-5 hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2"
