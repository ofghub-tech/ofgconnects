...
export const COLLECTION_ID_SUBSCRIPTIONS = process.env.REACT_APP_COLLECTION_ID_SUBSCRIPTIONS; 
export const COLLECTION_ID_LIKES = process.env.REACT_APP_COLLECTION_ID_LIKES; 

// --- UPDATED ---
// Removed COLLECTION_ID_VERSES and added COLLECTION_ID_BIBLE
export const COLLECTION_ID_BIBLE = process.env.REACT_APP_COLLECTION_ID_BIBLE; 
// --- END UPDATE ---
...
export const COLLECTION_ID_WATCH_LATER = process.env.REACT_APP_COLLECTION_ID_WATCH_LATER;